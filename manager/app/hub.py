...
class Hub(QObject):
    ...
    def create_new_wallet(self, mnemonic_seed=u''):
        ...
        try:
            ...
            if has_password:
                ...
                wallet_log_path = os.path.join(wallet_dir_path, 'BitcoinMedal-wallet-cli.log')
    ...
    def restart_daemon(self):
        self.app_process_events(1)
        self.ui.BitcoinMedald_daemon_manager.stop()
    ...
    def view_daemon_log(self):
        log_file = os.path.join(DATA_DIR, 'logs', "BitcoinMedald.log")
